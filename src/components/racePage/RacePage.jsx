...
import elk from "../../assets/images/elk.jpeg";
...
const RacePage = () => {
  ...
  return (
    <div className="race">
      <div className="race__background">
        <img src={elk} alt="elk busse" />
        <div className="race__overlay"></div>
      </div>
      <div className="race__content">
        <div className="race__content__container">
          <FontAwesomeIcon
            icon={faLocationDot}
            className="race__content__container__icon"
          />
          <a
            href="https://maps.google.com?q=Busse+Woods+IL+60008"
            target="_blank"
            rel="noopener noreferrer"
            className="race__content__container__link"
          >
            Busse Woods, IL 60008
          </a>
        </div>

        <div className="race__content__container2">
          <p>
