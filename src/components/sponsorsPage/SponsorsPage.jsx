  ...
  return (
    <div className="sponsors">
      ...
      <p>
        ...
        commitment to our event underscores their belief in its significance and
        impact, and we are truly honored to have them by our side.
        <br />
        <br />
        As we come together to celebrate this extraordinary event, we extend our
        heartfelt thanks to each and every one of our partners and sponsors.
        Your support fuels our passion and inspires us to continue pushing the
        boundaries of excellence in the running community. We look forward to
        continuing this journey together, creating lasting memories and forging
        meaningful connections with runners from around the world.
      </p>
      <p>
      ...
      <div className="sponsors__container">
        <div className="sponsors__container__sponsor">
          <img
